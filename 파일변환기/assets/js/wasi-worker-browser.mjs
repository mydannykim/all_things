// node_modules/@emnapi/wasi-threads/dist/wasi-threads.esm-bundler.js
...
function createInstanceProxy(instance, memory) {
  ...
  var handler2 = createHandler(originalExports);
  ...
  var exportsProxy = new Proxy(/* @__PURE__ */ Object.create(null), handler2);
...
var ThreadMessageHandler = /* @__PURE__ */ (function() {
  function ThreadMessageHandler2(options) {
  ...
  ThreadMessageHandler2.prototype.instantiate = function(data) {
    if (typeof this.onLoad === "function") {
      return this.onLoad(data);
    }
    throw new Error("ThreadMessageHandler.prototype.instantiate is not implemented");
  };
  ThreadMessageHandler2.prototype.handle = function(e) {
    var _this = this;
    var _a;
  ...
  ThreadMessageHandler2.prototype._load = function(payload) {
    var _this = this;
    ...
    if (typeof then === "function") {
      then.call(source, function(source2) {
        _this._loaded(null, source2, payload);
      }, function(err) {
  ...
  ThreadMessageHandler2.prototype._start = function(payload) {
    ...
    var postMessage2 = this.postMessage;
    var tid = payload.tid;
  ...
  ThreadMessageHandler2.prototype._loaded = function(err, source, payload) {
    if (err) {
      notifyPthreadCreateResult(payload.sab, 2, err);
      throw err;
    }
  ...
  ThreadMessageHandler2.prototype.handleAfterLoad = function(e, f) {
    if (this.instance !== void 0) {
      f.call(this, e);
    } else {
...
// node_modules/@emnapi/core/node_modules/tslib/tslib.es6.mjs
  ...
  var napiModule = (function() {
    ...
    function emnapiAddSendListener(worker) {
      ...
      var dispose = function() {
        if (ENVIRONMENT_IS_NODE2) {
          worker.off("message", handler2);
        } else {
          worker.removeEventListener("message", handler2, false);
        }
        delete worker._emnapiSendListener;
      };
      worker._emnapiSendListener = { handler: handler2, dispose };
      if (ENVIRONMENT_IS_NODE2) {
        worker.on("message", handler2);
      } else {
        worker.addEventListener("message", handler2, false);
      }
      return true;
    }
    ...
    var emnapiTSFN = {
      ...
      addListener: function(worker) {
        ...
        worker._emnapiTSFNListener = { handler: handler2, dispose };
        if (ENVIRONMENT_IS_NODE2) {
          worker.on("message", handler2);
        } else {
          worker.addEventListener("message", handler2, false);
    ...
    var emnapiAWMT = {
      ...
      addListener: function(worker) {
        ...
        worker._emnapiAWMTListener = { handler: handler2, dispose };
        if (ENVIRONMENT_IS_NODE2) {
          worker.on("message", handler2);
        } else {
          worker.addEventListener("message", handler2, false);
      ...
      cancelWork: function(work) {
        ...
        if (Atomics.compareExchange(
          new Int32Array(emnapiAWMT.ensureBufferFor(work + emnapiAWMT.offset.status + 4), work + emnapiAWMT.offset.status, 1),
          0,
          0,
          1
...
var MessageHandler = /* @__PURE__ */ (function(_super) {
  __extends(MessageHandler2, _super);
  function MessageHandler2(options) {
    var _this = this;
  ...
  MessageHandler2.prototype.instantiate = function(data) {
    var _this = this;
  ...
  MessageHandler2.prototype.handle = function(e) {
    var _this = this;
    var _a;
...
// node_modules/@ohah/hwpjs/dist/wasi-worker-browser.mjs
